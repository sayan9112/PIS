...
class Print_Data implements ActionListener{
    ...
    String emp_id,name,father,address,phone,email,department,stream,age,dob,avg_marks;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        try{
            conn con = new conn();
            String str = "select * from STUDENT1 where ID = '"+e_id+"'";
            ...
            while(rs.next()){
                ...
                avg_marks = rs.getString("avg_marks");
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("icons/print1.png"));
        id9.setIcon(img);

        id8 = new JLabel("Personal Details");
