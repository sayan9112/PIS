...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        */
        ...
        f=new JFrame("Update Student Records");
        f.setVisible(true);
        f.setSize(900,500);
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from STUDENT1 where ID = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update STUDENT1 set ID='"+t1.getText()+"',name='"+t2.getText()+"',fname='"+t3.getText()+"',age='"+t4.getText()+"',dob='"+t5.getText()+"',address='"+t6.getText()+"',phone='"+t7.getText()+"',email='"+t8.getText()+"',department='"+t9.getText()+"',stream='"+t10.getText()+"',avg_marks='"+t11.getText()+"' where id='"+id_emp+"'";
